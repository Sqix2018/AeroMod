// Vendored from frida-objc-bridge 8.0.6 (npm), converted from ES modules to
// CommonJS for tools/bundle.ps1. License: LGPL-2.0 WITH WxWindows-exception-3.1.
let cachedApi = null;
...
function getApi() {
    ...
    pending.forEach(function (api) {
        ...
        const exportModule = Process.findModuleByName(api.module);
        const exportByName = (exportModule !== null && exportModule !== undefined ? exportModule.enumerateExports() : [])
...
module.exports = { defaultInvocationOptions, getApi };
